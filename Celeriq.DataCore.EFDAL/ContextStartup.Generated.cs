...
namespace Celeriq.DataCore.EFDAL
{
	...
	public partial class ContextStartup
	{
		...
		/// Creates a new instance of the ContextStartup object
		/// </summary>
		public ContextStartup(string modifier, bool allowLazyLoading, int commandTimeout, bool isAdmin) :
			this(modifier, allowLazyLoading)
		{
			this.CommandTimeout = commandTimeout;
		...
		/// <summary>
		/// Determines the connection string is for an admin user that can see all tenant based data
		/// </summary>
