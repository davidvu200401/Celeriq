...
namespace Celeriq.DataCore.EFDAL
{
	internal class DBHelper
	{
		...
		{
			return GetConnection(Celeriq.DataCore.EFDAL.DataCoreEntities.GetConnectionString());
		}
	...
	{
		DataCoreEntities Context { get; set; }
	}
	...
	internal class Util
	{
		...
		{
			var tempPlatform = System.Configuration.ConfigurationManager.AppSettings["DataCoreEntities.Platform"];
		...
		{
			return ConvertNormalCS2EFFromConfig(configSettings, new ContextStartup(string.Empty, false, 0, GetDefinedPlatform()));
		}
		...
		{
			return ConvertNormalCS2EF(connectionString, new ContextStartup(string.Empty, false, 0, GetDefinedPlatform()));
		}
		...
		internal static string ConvertNormalCS2EF(string connectionString, ContextStartup contextStartup)
		{
			...
			if (contextStartup.CurrentPlatform == DatabasePlatformConstants.MySql)
				return @"metadata=res://*/Celeriq.DataCore.EFDAL.DataCore.MySql.csdl|res://*/Celeriq.DataCore.EFDAL.DataCore.MySql.ssdl|res://*/Celeriq.DataCore.EFDAL.DataCore.msl;provider=MySql.Data.MySqlClient;provider connection string='" + connectionString + "'";
			else if (contextStartup.CurrentPlatform == DatabasePlatformConstants.SQLServer)
			{
				if (contextStartup.IsAdmin)
					return @"metadata=res://*/Celeriq.DataCore.EFDAL.DataCore.csdl|res://*/Celeriq.DataCore.EFDAL.DataCore.Admin.ssdl|res://*/Celeriq.DataCore.EFDAL.DataCore.Admin.msl;provider=System.Data.SqlClient;provider connection string='" + connectionString + "'";
				else
					return @"metadata=res://*/Celeriq.DataCore.EFDAL.DataCore.csdl|res://*/Celeriq.DataCore.EFDAL.DataCore.ssdl|res://*/Celeriq.DataCore.EFDAL.DataCore.msl;provider=System.Data.SqlClient;provider connection string='" + connectionString + "'";
			}
			else
