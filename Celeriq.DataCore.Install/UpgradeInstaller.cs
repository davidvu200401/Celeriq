...
namespace Celeriq.DataCore.Install
{
	...
	internal class UpgradeInstaller
	{
		...
		internal const string DEFAULT_NAMESPACE = "Celeriq.DataCore.Install";
		internal const string MODELKEY = "b3fc7837-d0f4-4f9a-a978-b02ac30b9594";
		private GeneratedVersion _previousVersion = null;
		private static GeneratedVersion _upgradeToVersion = new GeneratedVersion(3, 0, 0, 0, 23);
