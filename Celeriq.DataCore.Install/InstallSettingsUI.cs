namespace Celeriq.DataCore.Install
{
	...
	internal partial class InstallSettingsUI : UserControl
	{
		...
		private void cmdHelp_Click(object sender, EventArgs e)
		{
			...
			sb.AppendLine();
			sb.AppendLine("InstallUtil.exe Celeriq.DataCore.Install.dll [/upgrade] [/create] [/master:connectionstring] [/connectionstring:connectionstring] [/newdb:name] [/showsql] [/notran] [/nonormalize] [/scriptfile:filename] [/scriptfileaction:append] [/usehashes]");
			sb.AppendLine();
